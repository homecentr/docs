...
<NetworkSubnet
    ...
    <table slot="staticAssignments">
        <tr>
            <tr><td>192.168.10.200</td><td><a href="/hardware/ubiquiti-usg-pro4">Ubiquiti USG-PRO4 (WAN port)</a></td></tr>
        </tr>
    </table>
...
<NetworkSubnet
    ...
    <table slot="staticAssignments">
        <tr>
            <tr><td>10.1.1.1</td><td><a href="/hardware/ubiquiti-usg-pro4">Ubiquiti USG-PRO4 (LAN port)</a></td></tr>
            <tr><td>10.1.1.10</td><td><a href="/hardware/ubiquiti-us-24">Ubiquiti US-24</a></td></tr>
            <tr><td>10.1.1.11</td><td><a href="/hardware/ubiquiti-us-8-150w">Ubiquiti US-8-150W</a></td></tr>
            <tr><td>10.1.1.20</td><td><a href="/hardware/ubiquiti-uap-nanohd">Ubiquiti UIAP-nanoHD</a></td></tr>
            <tr><td>10.1.1.21</td><td><a href="/hardware/ubiquiti-uap-nanohd">Ubiquiti UIAP-nanoHD</a></td></tr>
            <tr><td>10.1.1.22</td><td><a href="/hardware/ubiquiti-ac-lite">Ubiquiti UAP-AC-Lite</a></td></tr>
        </tr>
    </table>
...
<NetworkSubnet
    ...
    internetAccess={true}>
        <div slot="staticAssignments">
            ...
            <table>
                <tr>
                    <tr><td>10.1.2.48</td><td>kube1 (on Dell R510)</td></tr>{/* Link to kubernetes */}
            ...
            Range 10.1.2.128-10.1.2.191 is used for services hosted in the <a href="/selfhosted/kubernetes">Kubernetes</a> cluster with a dedicated ip address. See the individual service pages for ip assignments.
        </div>
...
| Name | Color | CIDR | VLAN ID | Internet access | Description |
|------|-------|------|---------|-----------------|-------------|
| WAN | <div class="subnet-color black"></div> | 192.168.10.0/24 | N/A | ✅ | Network between gateway and ISP's antenna |
| Infrastructure | <div class="subnet-color white"></div> | 10.1.1.0/24 | 10 | ✅ | Trunk network between Unifi devices |
| Services | <div class="subnet-color yellow"></div> | 10.1.2.0/24 | 20 | ✅ | Servers providing services to other subnets |
| Home | <div class="subnet-color blue"></div> | 10.1.3.0/24 | 30 | ✅ | Home devices (laptops, phones, smart home devices etc.) |
| Guests | <div class="subnet-color green"></div> | 10.1.4.0/24 | 40 | ✅ | Guest wifi devices |
| Toxic | <div class="subnet-color red"></div> | 10.1.5.0/24 | 50 | ✅ | Repaired devices |
*/}